...
// import { Color, PCFSoftShadowMap, Vector2, Vector3, Vector4 } from 'three';
...
const assetBase = API_ROUTES.threeDModuleAssetsBase;
...
export const parameters = {
  ...
  mazeParameters: { helpersColor: new THREE.Color(0xff0077) },
  playerParameters: { helpersColor: new THREE.Color(0x0055ff) },
  ...
  shadowsParameters: { type: THREE.PCFSoftShadowMap },
  fogParameters: {},
