# ID 300 - List building floors served by elevator

## Description
Create a GET method to retrieve a list of floors in a building that have a elevator.

## Acceptance Criteria

* Can get a list of floors that have elevator.
